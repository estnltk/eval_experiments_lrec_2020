#
#  Annotates given documents for v1_6 corpus-based morph_analysis/
#  disambiguation and saves the results as JSON files.
#
...
vm_corpus_tagger = VabamorfCorpusTagger(output_layer='cb_morph_analysis')
...
# output dir
output_dir = 'estnltk_cb_morph_annotated'
...
for doc in iterator.iterate():
    ...
    # Add cb morph_analysis
    vm_corpus_tagger.tag( [doc] )
